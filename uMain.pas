...
type
  Tfml_main = class(TForm)
    ...
    procedure pRelatorioEntradaSaidaMouseLeave(Sender: TObject);
    procedure pRelatorioEntradaSaidaMouseMove(Sender: TObject;
      Shift: TShiftState; X, Y: Integer);
    procedure pRelatorioBuscaMouseLeave(Sender: TObject);
    procedure pRelatorioBuscaMouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure pRelatorioAnualMouseLeave(Sender: TObject);
    procedure pRelatorioAnualMouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
  private
...
procedure Tfml_main.pRelatorioBuscaMouseLeave(Sender: TObject);
begin
  if not open_busca then
    begin
      pRelatorioBusca.Font.Color := clblack;
...
procedure Tfml_main.pRelatorioBuscaMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  if not open_busca then
      begin
...
procedure Tfml_main.pRelatorioEntradaSaidaMouseLeave(Sender: TObject);
begin
  if not open_SaidaEntrada then
    begin
      pRelatorioEntradaSaida.Font.Color := clBlack;
...
procedure Tfml_main.pRelatorioEntradaSaidaMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  if not open_SaidaEntrada then
    begin
...
procedure Tfml_main.pRelatorioAnualMouseLeave(Sender: TObject);
begin
  if not open_anual then
    begin
      pRelatorioAnual.Font.Color := clblack;
...
procedure Tfml_main.pRelatorioAnualMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
    if not open_anual then
      begin
